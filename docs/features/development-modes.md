...
**When to use:** When you fully trust the AI and want zero interruptions. Use with caution — yolo skips the confirm prompt. File tools still stay inside the project; `execute_bash` does not unless you turn on `nanocoder.sandbox` (see [Configuration](../configuration/index.md#os-sandbox)).
